...
public class MainActivity extends Activity {
	...
	// TRIM to 42 items
	String products[] = { "Air Freshener", "Aluminum Foil", "Apples",
			"Apple Sauce", "Baby Food", "Bacon", "Bags", "Bagels",
			"Bakery Goods", "Baking Soda", "Bananas", "Beans", "Beef", "Beer",
			"Biscuit Mix", "Bread", "Broccoli", "Cheese", "Cherries",
			"Chicken", "Chili", "Chips", "Corn", "Corn meal", "Corn Starch",
			"Corn Syrup", "Crackers", "Cream Cheese", "Cream", "Cucumber",
			"Dessert", "Fruit", "Garlic", "Gum", "Ham", "Ice Cream",
	...
	private void displayListView() {
		...
		// initialize view elements (search bar and list of check-box items)
		// from XML resources
		ListView listView = (ListView) findViewById(R.id.list_view);
		EditText inputSearch = (EditText) findViewById(R.id.inputSearch);
		// Assign adapter to the ListView to fill the view with the product
		// names of type Item
	...
	private class MyCustomAdapter extends ArrayAdapter<Item> implements
			Filterable {
	...
	private void checkButtonClick() {
		...
		mapButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				myItems.removeAll(myItems);
				// now populate the ArrayList myItems based based on if Item is
				// selected
				ArrayList<Item> itemList = dataAdapter.itemList;
				for (int i = 0; i < itemList.size(); i++) {
					Item item = itemList.get(i);
